...
import CarPage from "./component/cars/car-page/car-page";
import CarBook from "./component/cars/car-book/car-book";
import Header from "./component/screen/Header";
import Footer from "./component/screen/Footer";
import WelcomeBlock from "./component/screen/Welcomblock";
    ...
    <>
      ...
      <div className="wrapper">
        ...
        <Routes>
          ...
          <Route path="car-book/:id" element={<CarBook />}/>
        </Routes>
